...
export const mockTimeWidgetData: HistoricalData = [
  {
    ...
    items: [
      {
        year: 1904,
        article: `Историческое событие ${41}: краткое описание события в этом году. Историческое событие ${41}: краткое описание события в этом году. Историческое событие ${41}: краткое описание события в этом году.`,
      },
